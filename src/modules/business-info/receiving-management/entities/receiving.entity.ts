...
export class Receiving extends BaseEntity {
    ...
    @Column({ name: 'receiving_code', type: 'varchar', length: 20 ,comment: '입고 코드' ,nullable: true})
    ...
    @Column({ name: 'customer_code', type: 'varchar', length: 20 ,comment: '거래처 코드' ,nullable: true})
    customerCode: string;

    @ApiProperty({ example: '거래처 명', description: '거래처 명' })
    @Column({ name: 'customer_name', type: 'varchar', length: 20 ,comment: '거래처 명' ,nullable: true})
    customerName: string;
    ...
    @Column({ name: 'lot_code', type: 'varchar', length: 20 ,comment: 'LOT 코드' ,nullable: true})
    lotCode: string;
    ...
    @Column({ name: 'warehouse_name', type: 'varchar', length: 20 ,comment: '창고 명' ,nullable: true})
